...
local garages = {
  {name="Garage", colour=3, id=357, x=1703.01, y=3597.39, z=35.488, h=0.0},
  {name="Garage", colour=3, id=357, x=-334.685, y=289.773, z=85.890, h=0.0},
  {name="Garage", colour=3, id=357, x=-55.272, y=-1838.71, z=26.500, h=0.0},
  {name="Garage", colour=3, id=357, x=126.434, y=6610.04, z=31.890, h=0.0},
  {name="Garage", colour=3, id=357, x=215.489, y=-789.807, z=30.9, h=0.0}, 
  {name="Garage", colour=3, id=357, x=2667.08, y=1671.27, z=24.549, h=0.0}, 
  {name="Garage", colour=3, id=357, x=36.003, y=-875.029, z=30.4, h=0.0},
  {name="Garage", colour=3, id=357, x=291.122, y=-338.088, z=45.0, h=0.0},
  {name="Garage", colour=3, id=357, x=1222.464, y=2709.40, z=38.02, h=0.0},
  {name="Garage", colour=3, id=357, x=2486.689, y=4118.995, z=38.10, h=0.0},
  {name="Garage", colour=3, id=357, x=-3248.768, y=991.168, z=12.50, h=0.0},
  {name="Garage", colour=3, id=357, x=-3047.700, y=600.959, z=7.30, h=0.0},
  {name="Garage", colour=3, id=357, x=-2032.561, y=-473.449, z=11.50, h=0.0},
  {name="Garage", colour=3, id=357, x=-1582.649, y=-1014.555, z=13.0, h=0.0},
  {name="Garage", colour=3, id=357, x=-796.162, y=-1284.970, z=5.0, h=0.0},
  {name="Garage", colour=3, id=357, x=2569.764, y=320.533, z=108.45, h=0.0},
  {name="Garage", colour=3, id=357, x=3573.258, y=3778.912, z=29.00, h=0.0},
  {name="Garage", colour=3, id=357, x=1695.880, y=4939.893, z=42.13, h=0.0},
  {name="Garage", colour=3, id=357, x=223.625, y=1223.685, z=225.50, h=0.0},
  {name="Garage", colour=3, id=357, x=-1913.113, y=2035.893, z=140.70, h=0.0},
  {name="Garage", colour=3, id=357, x=-1820.702, y=809.011, z=138.88, h=0.0},
  {name="Garage", colour=3, id=357, x=-755.846, y=5540.000, z=33.50, h=0.0},
  {name="Garage", x=1129.82, y=-793.82, z=56.620, h=0.0},
  {name="Garage", x=1406.855, y=1118.308, z=114.837, h=0.0},
  {name="Garage", x=-1530.9027099609, y=84.272033691406, z=56.708927154541, h=0.0},
  {name="Garage", x=87.898658752441, y=-1969.3287353516, z=20.747470855713, h=0.0},
  {name="Garage", x=14.54638004303, y=547.85467529297, z=176.14010620117, h=0.0}, -- Members Only
  {name="Garage", x=-825.48760986328, y=180.03248596191, z=71.477432250977, h=0.0}, -- Mafia
  {name="Garage", x=950.11114501953, y=-122.76261138916, z=74.353134155273, h=0.0}, -- HA
  {name="Garage", x=-552.84252929688, y=302.16781616211, z=83.183700561523, h=0.0}, -- Lost
  {name="Garage", x=-15.169131278992, y=-1085.6313476563, z=26.7, h=0.0}, -- Bilforhandler
  {name="Garage", x=329.26654052734, y=-2035.6627197266, z=21.0, h=0.0}, -- Carola
  ...
  Citizen.CreateThread(function()
    while true do
      ...
      for _, garage in pairs(garages) do
        DrawMarker(36, garage.x, garage.y, garage.z, 0, 0, 0, 0, 0, 0, 1.000, 1.000, 1.000, 0, 153, 255, 255, 0, 1, 0, 50)
        if GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 3 and IsPedInAnyVehicle(LocalPed(), true) == false then
          DrawText3Ds(garage.x, garage.y, garage.z + 0.4, "Tryk ~b~[E]~w~ for at åbne garagen.")
  ...
  while true do
    ...
    for _, garage in pairs(garages) do
      ...
      if GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 3 and IsPedSittingInAnyVehicle(GetPlayerPed(-1)) then
        DrawText3Ds(garage.x, garage.y, garage.z, "Tryk ~g~E~w~ for at opbevare køretøjet.")
        --elseif GetDistanceBetweenCoords(garage.x, garage.y, garage.z, GetEntityCoords(LocalPed())) < 3 then
        --   DrawText3Ds(garage.x, garage.y, garage.z, "Stig ud af dit fucking køretøj.")
        if IsControlJustPressed(1, 38) then
          garageSelected.x = garage.x
