...
--MySQL.createCommand("vRP/remove_vehicle","DELETE FROM vrp_user_vehicles WHERE user_id = @user_id, vehicle_plate = @registration AND vehicle = @vehicle")
...
if address then
  ...
  elseif address.home == "Exclusive flat 2" then
    TriggerClientEvent("ply_garages:addAptGarage", player, -555.25201416016,665.62176513672,143.97505187988,339.229705810547)
  elseif address.home == "Vinewood Luxury" then
    TriggerClientEvent("ply_garages:addAptGarage", player, -187.68026733398,501.3840637207,133.65843200684,339.229705810547)
  elseif address.home == "Exclusive flat" then
    TriggerClientEvent("ply_garages:addAptGarage", player, 131.67933654785,567.50860595703,182.55195617676,339.229705810547)
  elseif address.home == "Rare flat" then
    TriggerClientEvent("ply_garages:addAptGarage", player, 354.25723266602,437.91806030273,145.43634033203,339.229705810547)
